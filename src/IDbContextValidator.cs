...
#endif
{
    ...
    {
        /// <summary>
        /// Validates all the table and column names of entities defined in the DbContext model against the actual database associated with the context.
        /// </summary>
        /// <param name="context">The context you want to validate against its actual database connection.</param>
        /// <param name="progress">The optional progress reporting the validated <see cref="Table"/>s. If <see langword="null"/>, no progress is reported.</param>
