...
#endif
{
    ...
    public interface IValidator
    {
        ...
        /// <param name="progress">A progress of <see cref="Validation" /> objects reporting numbers between 0.0 and 1.0 representing the completed fraction of the validation process. If <code>null</code>, no progress is reported.</param>
        ...
        Task<bool> ValidateSchemaAsync(DbContext context, IProgress<Validation> progress = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}